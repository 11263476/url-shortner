  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-zinc-950 px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="space-y-3 rounded-xl border border-zinc-800 bg-zinc-900/80 p-8 shadow-2xl backdrop-blur-sm">
          <p className="text-center text-sm text-zinc-400">Or continue with</p>
          <div className="grid gap-3">
            <button onClick={() => handleOAuth("google")} className="flex items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 hover:bg-zinc-100">
            ...
            <button onClick={() => handleOAuth("github")} className="flex items-center justify-center gap-2 rounded-lg border border-zinc-600 bg-zinc-800 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-700">
...
export default function LoginPage() {
  return <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-zinc-950 text-white">Loading...</div>}><LoginForm /></Suspense>
}
